<%@ Page Title="" Language="C#" MasterPageFile="~/CustomerMaster.master" AutoEventWireup="true" CodeFile="CustomerRegister.aspx.cs" Inherits="CustomerRegister" ValidateRequest="false" %>
                        ...
                        <div class="panel-body">
                            <div class="box box-primary">
                                <div class="box-body box-profile">
                                    ...
                                    <br />
                                    <br />
                                    <asp:Panel ID="PnlCustomerUser" runat="server">
                                        <asp:HiddenField ID="rec_id" runat="server" />

                                        <div class="row">
                                            <div class="col-md-3">
                                                <label style="font-size: 12px">Role Name</label>
                                            </div>
                                            <div class="col-md-9">
                                                <asp:DropDownList ID="RoleID" CssClass="form-control" runat="server"></asp:DropDownList>

                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label style="font-size: 12px">Full Names</label>
                                            </div>
                                            <div class="col-md-9">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <asp:TextBox ID="email" CssClass="form-control" runat="server" autocomplete="off"></asp:TextBox>

                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label style="font-size: 12px">Telephone Number</label>
                                            </div>
                                            <div class="col-md-9">
                                                <asp:TextBox ID="telephone" CssClass="form-control decimal" runat="server"></asp:TextBox>

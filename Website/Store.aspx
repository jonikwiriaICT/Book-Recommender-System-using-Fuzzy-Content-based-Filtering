<%@ Page Title="" Language="C#" MasterPageFile="~/BoutiqueMaster.master" AutoEventWireup="true" CodeFile="Store.aspx.cs" Inherits="Store" ValidateRequest="false" %>
                                ...
                                <div class="box-body box-profile">
                                    ...
                                    <asp:Panel ID="PnlStore" runat="server">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <asp:TextBox ID="store_name" CssClass="form-control" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label style="font-size: 12px">Store Address</label>
                                            </div>
                                            <div class="col-md-9">
                                                <asp:TextBox ID="store_address" CssClass="form-control" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3">

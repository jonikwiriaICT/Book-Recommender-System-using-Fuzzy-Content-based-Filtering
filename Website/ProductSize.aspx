<%@ Page Title="" Language="C#" MasterPageFile="~/BoutiqueMaster.master" AutoEventWireup="true" CodeFile="ProductSize.aspx.cs" Inherits="ProductSize" ValidateRequest="false" %>
                        ...
                        <div class="panel-body">
                            <div class="box box-primary">
                                <div class="box-body box-profile">
                                    ...
                                    <br />
                                    <br />
                                    <asp:Panel ID="PnlProductSize" runat="server">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <asp:DropDownList ID="product_id" CssClass="form-control select2-dropdown" runat="server"></asp:DropDownList>

                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label style="font-size: 12px">Product Size</label>
                                            </div>
                                            <div class="col-md-9">
                                                <asp:DropDownList ID="size_name" CssClass="form-control select2-dropdown" runat="server">
                                                    <asp:ListItem Value="XXS">Extra Extra Small</asp:ListItem>
                                                    ...
                                                    <asp:ListItem Value="XXL">Extra Extra Large</asp:ListItem>
                                                </asp:DropDownList>

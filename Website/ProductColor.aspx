<%@ Page Title="" Language="C#" MasterPageFile="~/BoutiqueMaster.master" AutoEventWireup="true" CodeFile="ProductColor.aspx.cs" Inherits="ProductColor" ValidateRequest="false" %>
                        ...
                        <div class="panel-body">
                            <div class="box box-primary">
                                <div class="box-body box-profile">
                                    ...
                                    <br />
                                    <br />
                                    <asp:Panel ID="PnlProductColor" runat="server">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label style="font-size: 12px">Color Name</label>
                                            </div>
                                            <div class="col-md-9">
                                                <asp:TextBox ID="color_name" CssClass="form-control" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
